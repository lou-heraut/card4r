...
- **`CARD_REF` monte en `v0.10.0` (2026-08-13).** 49 valeurs de la
  ...
  de Mann-Kendall. Côté R, `card_trend()` en tient compte sans rien
  changer à son appel : `null` ne calcule pas de pente relative, comme
  `false`. Détail : le CHANGELOG de card, version 0.10.0, et la section
  7 bis de son `NOMENCLATURE.md`.
