...
A `data.frame` goes in, `data.frame`s and their metadata come out. Which
means the numbers you get are the same ones, to the last digit, whichever
language you call them from.
